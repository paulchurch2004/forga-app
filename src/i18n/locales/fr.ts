export const fr = {
  ...
  welcomeFeatureMealsDesc: '500+ recettes eco ou premium, adaptees a chaque moment de la journee.',
  ...
  welcomeProFeat1: 'Catalogue complet (500+ recettes)',
  ...
  exHipThrust: 'Hip Thrust (barre)',
  exGluteBridge: 'Glute Bridge',
  exBulgarianSplitSquat: 'Bulgarian Split Squat',
  exCableKickbacks: 'Cable Kickbacks',
  exSumoDeadlift: 'Souleve de terre Sumo',
  exGoodMorning: 'Good Morning',
  exWalkingLunges: 'Walking Lunges',
  exSingleLegHipThrust: 'Hip Thrust unilateral',
  exPauseHipThrust: 'Hip Thrust pause 3s',
  exAbductorMachine: 'Machine Abducteurs',
  exBandedSideWalk: 'Marche laterale elastique',
  exStepUps: 'Step-ups',
  exFrontSquat: 'Front Squat',
  exGobletSquat: 'Goblet Squat',
  exPauseSquat: 'Pause Squat 2s',
  exPistolSquat: 'Pistol Squat',
  exSeatedCableRow: 'Rowing assis a la poulie',
  exTBarRow: 'T-Bar Row',
  exPendlayRow: 'Pendlay Row',
  exRackPull: 'Rack Pull',
  exReversePecDeck: 'Pec Deck inverse',
  exInclineDbPress: 'Developpe incline halteres',
  exCloseGripBench: 'Developpe couche prise serree',
  exPauseBench: 'Bench Press pause 2s',
  exCableFly: 'Ecarte a la poulie',
  exPecDeck: 'Pec Deck',
  exInclineFly: 'Ecarte incline',
  exSeatedDbPress: 'Developpe assis halteres',
  exUprightRow: 'Rowing menton',
  exCableLateral: 'Elevations laterales poulie',
  exPreacherCurl: 'Curl au pupitre',
  exConcentrationCurl: 'Curl concentre',
  exCableCurls: 'Curl a la poulie',
  exBarbellCurl: 'Curl a la barre',
  exInclineDbCurl: 'Curl incline halteres',
  exTricepPushdown: 'Extensions triceps poulie',
  exOverheadTricepExtension: 'Extensions triceps au-dessus tete',
  exJmPress: 'JM Press',
  exHangingLegRaise: 'Releve de jambes suspendu',
  exAbWheel: 'Roue abdominale',
  exCableCrunch: 'Crunch a la poulie',
  ...
  ritualEyebrow: 'CHECK-IN DU MATIN · 15 SEC',
  ritualTitle: 'Comment tu te sens ?',
  ritualSubtitle: "Ton plan s'adapte automatiquement : charges, volume, macros. Choisis ton etat.",
  ritualHint: "Touche un metal pour voir comment ton plan s'adapte...",
  ritualPreviewLabel: 'IMPACT SUR TA JOURNEE',
  ritualConfirmCta: 'Forger ma journee',
  ritualResetCta: 'Modifier',
  ritualMetalPlomb: 'Plomb',
  ritualMetalBronze: 'Bronze',
  ritualMetalFer: 'Fer',
  ritualMetalAcier: 'Acier',
  ritualMetalOr: 'Or',
  ritualImpactPlomb: 'Seance allegee, focus mobilite, dejeuner riche en glucides.',
  ritualImpactBronze: 'Volume reduit, intensite moderee, recuperation prioritaire.',
  ritualImpactFer: 'Plan standard. On execute proprement.',
  ritualImpactAcier: 'Charges relevees, volume optimal, on pousse.',
  ...
  coachFocusEyebrow: "COACH · A L'INSTANT",
  coachFocusOpener: 'On demarre la journee. Logge ton premier repas pour calibrer.',
  coachFocusOpenerWithSlot: 'On demarre avec {slot}. Vise {grams}g de prot pour bien lancer la journee.',
  coachFocusDayDone: 'Objectifs du jour atteints. Bien joue.',
  coachFocusProteinLever: '{slot} est ton levier prot. Il te reste {grams}g.',
  coachFocusDinnerLever: 'Ton diner est le levier cle. Il te reste {grams}g de prot.',
  coachFocusGenericForSlot: 'Il te reste {kcal} kcal et {grams}g de prot pour {slot}.',
  coachFocusGenericRest: "Il te reste {kcal} kcal et {grams}g de prot aujourd'hui.",

  // ── Redesign : Quick access tiles ──
  tileNutritionEyebrow: 'Nutrition',
  tileNutritionTitle: 'Plan du jour',
  tileNutritionSubtitle: '{consumed} / {target} kcal',
  tileSeanceEyebrow: 'Seance',
  tileSeanceRestTitle: 'Repos',
  tileSeanceRestSubNoPlan: 'Choisis un programme',
  tileSeanceRestSubNoToday: 'Pas de seance prevue',
  tileSeanceMin: 'min',
  homeTodayLabel: "AUJOURD'HUI",

  // ── Redesign : Mini stats ──
  miniStatCalories: 'Calories',
  miniStatProteins: 'Proteines',
  miniStatWater: 'Eau',
  miniStatCarbs: 'Glucides',
  ...
  mealSlotEmpty: 'Ajouter un repas',
  mealsOfDayLabelUpper: 'REPAS DU JOUR',

  // ── Redesign : Primary meal action ──
  primaryMealActionTitle: 'Logger {slot}',
  primaryMealActionHint: 'Photo, scan, ou recherche',
  primaryMealActionFallback: 'le prochain repas',

  // ── Redesign : Quick log FAB ──
  fabScanBarcode: 'Scanner code-barre',
  fabPhoto: 'Photo repas',
  fabSearch: 'Recherche recette',

  // ── Redesign : Validated meal overlay ──
  validatedMealTitle: 'Repas valide',
  validatedMealSubtitle: '+{kcal} kcal · +{protein}g prot',

  // ── Redesign : Compare table (paywall) ──
  compareFeatureCol: 'FONCTIONNALITE',
  compareFreeCol: 'GRATUIT',
  compareProCol: 'PRO',
  compareUnavailable: 'Non disponible',
  compareFeature1: '510 recettes premium',
  ...
  compareFeature7Free: 'Non disponible',
  ...
  profileWeeklyReportTitle: 'Voir ma revue de semaine',

  // ── Redesign : Metal frieze ──
  metalLegendOr: 'Or',
  metalLegendAcier: 'Acier',
  metalLegendFer: 'Fer',
  metalLegendBronze: 'Bronze',
  metalSolidsCount: '{count}/30 solides',

  // ── Redesign : PR cards ──
  prPreviousLabel: 'Precedent {value} {unit} · {date}',
  prDateToday: "Aujourd'hui",
  prDateYesterday: 'Hier',
  prDateDaysAgo: 'Il y a {n}j',
  prDateWeeksAgo: 'Il y a {n}sem',
  prDateMonthsAgo: 'Il y a {n}mois',

  // ── Redesign : Coach mode toggle ──
  coachModePresence: 'Presence',
  coachModeConversation: 'Conversation',
  coachModePresenceHelp: "Il t'observe, note ce qu'il voit, et t'alerte au bon moment.",
  coachModeConversationHelp: 'Pose tes questions, demande des conseils. Reponse instantanee.',

  // ── Redesign : Coach presence view ──
  presenceFocusEyebrow: 'FOCUS DU JOUR · {time}',
  presenceObservedLabel: "CE QU'IL A OBSERVE",
  presenceSwitchToConversation: 'Une question ? Passe en conversation',
  ...
  sessionForgeeTitle: 'SESSION FORGEE',
  sessionForgeeWellDone: 'Bien joue,\n{name}.',
  sessionForgeeDuration: 'Duree',
  sessionForgeeDurationUnit: 'min',
  sessionForgeeVolume: 'Volume',
  sessionForgeeVolumeUnit: 'kg',
  sessionForgeePr: 'PR',
  sessionForgeeNewRecord: 'NOUVEAU RECORD',

  // ── Redesign : Rest circle timer ──
  restOptimal: 'REPOS OPTIMAL',
  restDefaultHint: 'Reconstitution phosphocreatine pour force max.',
  restSkip: 'Passer',

  // ── Redesign : Onboarding archétype ──
  archetypeStep1Eyebrow: 'ETAPE 1 · ARCHETYPE',
  archetypeStep1Title: 'Quel type de\nforgeron es-tu ?',
  archetypeStep1Subtitle: "Ton archetype calibre tout : macros, charges, style de coaching. Tu pourras l'affiner plus tard.",
  archetypeStep2Eyebrow: 'ETAPE 2 · CALIBRAGE',
  archetypeStep2Title: 'Tu es un {archetype}.\nOn precise.',
  archetypeFirstNameLabel: 'TON PRENOM',
  archetypeIntensityLabel: 'INTENSITE VOULUE',
  archetypeIntensity1: 'Doux',
  archetypeIntensity2: 'Modere',
  archetypeIntensity3: 'Soutenu',
  archetypeIntensity4: 'Intense',
  archetypeIntensity5: 'Extreme',
  archetypePlanLabel: 'TON PLAN CALIBRE',
  archetypePlanCalories: 'Calories',
  archetypePlanProteins: 'Proteines',
  archetypePlanSessions: 'Seances',
  archetypePlanSessionsUnit: '/sem',
  ...
  archetypeWarriorTrait4: 'Alimentation dense',
  archetypeCraftsmanTrait1: 'Recomposition',
  archetypeCraftsmanTrait2: 'Technique fine',
  archetypeCraftsmanTrait3: 'Suivi rigoureux',
  archetypeCraftsmanTrait4: 'Equilibre macros',
  archetypeExplorerTrait1: 'Forme generale',
  archetypeExplorerTrait2: 'Endurance',
  archetypeExplorerTrait3: 'Mobilite',
  archetypeExplorerTrait4: 'Alimentation flexible',

  // ── Redesign : Weekly Review ──
  weeklyReviewTitle: 'Rapport hebdo',
  weeklyReviewWeekLabel: 'Semaine {week} · {start}-{end}',
  weeklyReviewScoreEyebrow: 'SCORE DE LA SEMAINE',
  weeklyReviewDeltaPositive: '+{delta} pts vs semaine derniere',
  weeklyReviewDeltaNegative: '{delta} pts vs semaine derniere',
  weeklyReviewAdhesionLabel: 'ADHESION',
  weeklyReviewAdhesionNutrition: 'Nutrition',
  weeklyReviewAdhesionTraining: 'Training',
  weeklyReviewAdhesionWater: 'Hydratation',
  weeklyReviewCoachLabel: 'TON COACH ANALYSE',
  weeklyReviewCoachOpenerExcellent: 'Excellente semaine {name}.',
  weeklyReviewCoachOpenerGood: 'Bonne semaine {name}.',
  weeklyReviewCoachOpenerMixed: 'Semaine en demi-teinte {name}.',
  weeklyReviewCoachStrongAfterNutrition: ' sur ton plan, ',
  weeklyReviewCoachStrongAfterOther: ' cette semaine, ',
  weeklyReviewCoachWeak: "point d'amelioration : ",
  weeklyReviewCoachAllGood: 'tout est solide. On garde le cap.',
  weeklyReviewCoachStrongNutrition: 'Adhesion nutrition {pct}%',
  weeklyReviewCoachStrongTraining: 'Discipline training {pct}%',
  weeklyReviewCoachStrongSessions: '{count} seances',
  weeklyReviewCoachStrongStreak: 'Streak qui tient',
  weeklyReviewCoachWeakWater: 'hydratation a {pct}%',
  weeklyReviewCoachWeakTraining: 'training a {pct}%',
  weeklyReviewCoachWeakNutrition: 'nutrition a {pct}%',
  weeklyReviewHighlightsLabel: 'HIGHLIGHTS',
  weeklyReviewHlPr: 'PR · {exercise}',
  weeklyReviewHlPrDelta: '{value} {unit} (+{delta})',
  weeklyReviewHlStreak: 'Streak {days} jours',
  weeklyReviewHlStreakBest: 'Meilleure serie',
  weeklyReviewHlStreakRecord: 'Record {best}',
  weeklyReviewHlVolume: 'Poids total deplace',
  weeklyReviewHlNutritionTarget: 'Objectif nutrition atteint',
  weeklyReviewHlNutritionDays: '{days} jours / 7',
  weeklyReviewPhotoLabel: 'PHOTO DE PROGRESSION',
  weeklyReviewPhotoLast: 'SEM. DERNIERE',
  weeklyReviewPhotoNew: 'NOUVELLE',

  // ── Redesign : Notifications setup ──
  notifSetupTitle: 'Notifications',
  notifSetupHeroTitle: 'Le coach te parle\nau bon moment.',
  notifSetupHeroSubtitle: '3 rappels essentiels par jour. Pas de spam, jamais le soir.',
  notifSetupPreview1Title: 'Bonjour {name}. Comment tu te sens ?',
  notifSetupPreview1Body: 'Touche un metal pour calibrer ton plan du jour.',
  notifSetupPreview2Title: 'Dejeuner dans 15 min',
  notifSetupPreview2Body: 'Bowl poulet quinoa · 520 kcal — pret a valider.',
  notifSetupPreview3Title: 'Seance Push prevue',
  notifSetupPreview3Body: 'Pecs & epaules · 60 min. On y va ?',
  notifSetupDisclaimer: 'Tu peux desactiver chaque type de notif depuis ton profil a tout moment.',
  notifSetupCta: 'Activer les notifications',
  notifSetupActivated: 'Notifications activees',
  notifsEnabled: 'Activees',
  notifsDisabled: 'Desactivees',

  // ── Redesign : Coaching tooltip ──
  tooltipEyebrow: 'COACH · ASTUCE',
  tooltipDefaultCta: 'OK, compris',
  tooltipMorningRitualTitle: 'Le check-in du matin',
  tooltipMorningRitualBody: "Touche un metal pour preciser ton etat. Plomb si tu es lourd, Or si tu petes le feu — ton plan du jour s'adapte.",
  tooltipCoachFocusTitle: 'Ton coach veille',
  tooltipCoachFocusBody: 'Cette carte affiche le levier le plus important pour ta journee. Tape dessus pour ouvrir une conversation.',

  // ── Redesign : Error states ──
  errorStateNetworkTitle: 'Pas de connexion',
  errorStateNetworkMessage: 'Verifie ton wifi ou ta data, on retentera tout de suite apres.',
  errorStateGenericTitle: 'Quelque chose a coince',
  errorStateGenericMessage: "On a pas pu charger cette section. Reessaie dans un instant.",
  errorStateRetry: 'Reessayer',
