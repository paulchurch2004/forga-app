...
export const BREAKFASTS_EXTRA: Meal[] = [
  ...
  // TOTAL: cal 369, P 21, C 28, F 20
  {
    ...
    slot: 'breakfast',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f7/Chilaquiles_at_the_Grand_Cantina%2C_Windsor%2C_Ontario%2C_2025-09-01_04.jpg/800px-Chilaquiles_at_the_Grand_Cantina%2C_Windsor%2C_Ontario%2C_2025-09-01_04.jpg',
    budget: 'eco',
  ...
  // TOTAL: cal 304, P 17, C 45, F 6
  {
    ...
    slot: 'breakfast',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Croissant-Petr_Kratochvil.jpg/800px-Croissant-Petr_Kratochvil.jpg',
    budget: 'eco',
    restrictions: ['halal', 'pork_free'],
    prepTimeMin: 3,
    difficulty: 1,
  ...
  // TOTAL: cal 300, P 22, C 48, F 2
  {
    ...
    slot: 'breakfast',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/4a/Brioche.jpg/800px-Brioche.jpg',
    budget: 'eco',
    restrictions: ['halal', 'pork_free'],
    prepTimeMin: 5,
    difficulty: 1,
  ...
  // TOTAL: cal 415, P 28, C 26, F 22
  {
    ...
    slot: 'breakfast',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/24/Traditional_Eggs_Benedict.jpg/800px-Traditional_Eggs_Benedict.jpg',
    budget: 'premium',
  ...
  // TOTAL: cal 324, P 24, C 49, F 3
  {
    ...
    slot: 'breakfast',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/58/Chinese_rice_congee.jpg/800px-Chinese_rice_congee.jpg',
    budget: 'eco',
  ...
  // TOTAL: cal 365, P 19, C 31, F 18
  {
    ...
    slot: 'breakfast',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/ff/Egg_Sandwich.jpg/800px-Egg_Sandwich.jpg',
    budget: 'eco',
    restrictions: ['halal', 'pork_free'],
    prepTimeMin: 12,
    difficulty: 1,
  ...
  // TOTAL: cal 332, P 14, C 54, F 7
  {
    ...
    slot: 'breakfast',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e8/Miso_Soup_001.jpg/800px-Miso_Soup_001.jpg',
    budget: 'eco',
  ...
  // TOTAL: cal 383, P 17, C 60, F 8
  {
    ...
    slot: 'breakfast',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/28/Matsunoya_Breakfast_20240421_102843.jpg/800px-Matsunoya_Breakfast_20240421_102843.jpg',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'lactose_free'],
    prepTimeMin: 10,
    difficulty: 1,
  ...
  // TOTAL: cal 349, P 16, C 39, F 14
  {
    ...
    slot: 'breakfast',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/bf/Ful_medames_%28arabic_meal%29.jpg/800px-Ful_medames_%28arabic_meal%29.jpg',
    budget: 'eco',
    restrictions: ['halal', 'pork_free'],
    prepTimeMin: 12,
    difficulty: 1,
  ...
  // TOTAL: cal 356, P 8, C 35, F 21
  {
    ...
    slot: 'breakfast',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/09/Zaatar_Mankousheh.jpg/800px-Zaatar_Mankousheh.jpg',
    budget: 'eco',
  ...
  // TOTAL: cal 386, P 14, C 61, F 10
  {
    ...
    slot: 'breakfast',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/bb/Beans_Ball-Akara.jpg/800px-Beans_Ball-Akara.jpg',
    budget: 'eco',
  ...
  // TOTAL: cal 343, P 19, C 52, F 7
  {
    ...
    slot: 'breakfast',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/57/Mmm...huevos_rancheros.jpg/800px-Mmm...huevos_rancheros.jpg',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'vegetarian'],
    prepTimeMin: 15,
    difficulty: 2,
  ...
  // TOTAL: cal 348, P 21, C 39, F 13
  {
    ...
    slot: 'breakfast',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e0/Arepas_Tradicionales.jpg/800px-Arepas_Tradicionales.jpg',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'gluten_free', 'lactose_free'],
    prepTimeMin: 12,
    difficulty: 1,
  ...
  // TOTAL: cal 338, P 11, C 43, F 15
  {
    ...
    slot: 'breakfast',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/4e/Tepung_casava.jpg/800px-Tepung_casava.jpg',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'gluten_free', 'lactose_free'],
    prepTimeMin: 15,
    difficulty: 2,
  ...
  // TOTAL: cal 311, P 5, C 69, F 3
  {
    ...
    slot: 'breakfast',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/07/McD-Egg-McMuffin.jpg/800px-McD-Egg-McMuffin.jpg',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'vegan', 'vegetarian', 'lactose_free'],
    prepTimeMin: 12,
    difficulty: 1,
  ...
  // TOTAL: cal 272, P 21, C 36, F 7
  {
    ...
    slot: 'breakfast',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/58/Ipomoea_batatas_006.JPG/800px-Ipomoea_batatas_006.JPG',
    budget: 'eco',
  ...
  // TOTAL: cal 307, P 25, C 5, F 21
  {
    ...
    slot: 'breakfast',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/42/FrenchToast.JPG/800px-FrenchToast.JPG',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'gluten_free'],
    prepTimeMin: 20,
    difficulty: 1,
