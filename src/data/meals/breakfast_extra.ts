...
export const BREAKFASTS_EXTRA: Meal[] = [
  ...
  // TOTAL: cal 300, P 22, C 48, F 2
  {
    ...
    slot: 'breakfast',
    photoUrl: 'https://images.pexels.com/photos/4428344/pexels-photo-4428344.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['halal', 'pork_free'],
    prepTimeMin: 5,
    difficulty: 1,
  ...
  // TOTAL: cal 344, P 17, C 66, F 1
  {
    ...
    slot: 'breakfast',
    photoUrl: 'https://images.pexels.com/photos/19969209/pexels-photo-19969209.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'gluten_free', 'lactose_free'],
    prepTimeMin: 15,
    difficulty: 2,
  ...
  // TOTAL: cal 365, P 19, C 31, F 18
  {
    ...
    slot: 'breakfast',
    photoUrl: 'https://images.pexels.com/photos/12148858/pexels-photo-12148858.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['halal', 'pork_free'],
    prepTimeMin: 12,
    difficulty: 1,
  ...
  // TOTAL: cal 248, P 13, C 19, F 14
  {
    ...
    slot: 'breakfast',
    photoUrl: 'https://images.pexels.com/photos/4869425/pexels-photo-4869425.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'gluten_free', 'lactose_free'],
    prepTimeMin: 18,
    difficulty: 2,
  ...
  // TOTAL: cal 338, P 11, C 43, F 15
  {
    ...
    slot: 'breakfast',
    photoUrl: 'https://images.pexels.com/photos/1603463/pexels-photo-1603463.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'gluten_free', 'lactose_free'],
    prepTimeMin: 15,
    difficulty: 2,
  ...
  // TOTAL: cal 310, P 9, C 48, F 12
  {
    ...
    slot: 'breakfast',
    photoUrl: 'https://images.pexels.com/photos/37050195/pexels-photo-37050195.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'gluten_free', 'lactose_free'],
    prepTimeMin: 10,
    difficulty: 1,
  ...
  // TOTAL: cal 278, P 23, C 27, F 9
  {
    ...
    slot: 'breakfast',
    photoUrl: 'https://images.pexels.com/photos/28525196/pexels-photo-28525196.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['halal', 'pork_free'],
    prepTimeMin: 15,
    difficulty: 2,
  ...
  // TOTAL: cal 349, P 7, C 60, F 12
  {
    ...
    slot: 'breakfast',
    photoUrl: 'https://images.pexels.com/photos/3035261/pexels-photo-3035261.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'vegan', 'vegetarian', 'lactose_free'],
    prepTimeMin: 8,
    difficulty: 1,
  ...
  // TOTAL: cal 301, P 12, C 36, F 14
  {
    ...
    slot: 'breakfast',
    photoUrl: 'https://images.pexels.com/photos/7936680/pexels-photo-7936680.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'vegan', 'vegetarian', 'lactose_free'],
    prepTimeMin: 5,
    difficulty: 1,
  ...
  // ADJUSTED: cal 309, P 16, C 25, F 16
  {
    ...
    slot: 'breakfast',
    photoUrl: 'https://images.pexels.com/photos/35828979/pexels-photo-35828979.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'gluten_free', 'lactose_free', 'vegetarian'],
    prepTimeMin: 15,
    difficulty: 2,
