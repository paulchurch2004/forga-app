...
export const LUNCHES_EXTRA: Meal[] = [
  ...
  // TOTAL => cal 406, P 41.9, C 31.2, F 12.8
  {
    ...
    slot: 'lunch',
    photoUrl: 'https://images.pexels.com/photos/1259999/pexels-photo-1259999.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'gluten_free', 'lactose_free'],
    prepTimeMin: 25,
    difficulty: 1,
  ...
  // TOTAL => cal 404, P 42.5, C 36.6, F 9.8
  {
    ...
    slot: 'lunch',
    photoUrl: 'https://images.pexels.com/photos/15913469/pexels-photo-15913469.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'gluten_free', 'lactose_free'],
    prepTimeMin: 15,
    difficulty: 1,
  ...
  // TOTAL => cal 475, P 43.7, C 36.8, F 16.2
  {
    ...
    slot: 'lunch',
    photoUrl: 'https://images.pexels.com/photos/5779364/pexels-photo-5779364.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'lactose_free'],
    prepTimeMin: 20,
    difficulty: 2,
  ...
  // TOTAL => cal 469, P 45.1, C 40.3, F 13.5
  {
    ...
    slot: 'lunch',
    photoUrl: 'https://images.pexels.com/photos/36916123/pexels-photo-36916123.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['halal', 'pork_free'],
    prepTimeMin: 35,
    difficulty: 2,
  ...
  // TOTAL => cal 508, P 52.5, C 47.5, F 12.1
  {
    ...
    slot: 'lunch',
    photoUrl: 'https://images.pexels.com/photos/27365284/pexels-photo-27365284.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'gluten_free', 'lactose_free'],
    prepTimeMin: 20,
    difficulty: 1,
  ...
  // TOTAL => cal 427, P 13.6, C 55.8, F 17
  {
    ...
    slot: 'lunch',
    photoUrl: 'https://images.pexels.com/photos/28286241/pexels-photo-28286241.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'vegan', 'vegetarian', 'gluten_free', 'lactose_free'],
    prepTimeMin: 20,
    difficulty: 1,
  ...
  // TOTAL => cal 294, P 21, C 26.4, F 13
  {
    ...
    slot: 'lunch',
    photoUrl: 'https://images.pexels.com/photos/17942484/pexels-photo-17942484.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'vegan', 'vegetarian', 'gluten_free', 'lactose_free'],
    prepTimeMin: 15,
    difficulty: 1,
  ...
  // TOTAL => cal 275, P 15, C 41.4, F 6.6
  {
    ...
    slot: 'lunch',
    photoUrl: 'https://images.pexels.com/photos/20722055/pexels-photo-20722055.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'vegan', 'vegetarian', 'lactose_free'],
    prepTimeMin: 25,
    difficulty: 2,
  ...
  // TOTAL => cal 339, P 25.5, C 8.3, F 22.9
  {
    ...
    slot: 'lunch',
    photoUrl: 'https://images.pexels.com/photos/1437268/pexels-photo-1437268.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
  ...
  // TOTAL => cal 299, P 10.6, C 28.9, F 16.5
  {
    ...
    slot: 'lunch',
    photoUrl: 'https://images.pexels.com/photos/14775660/pexels-photo-14775660.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'vegetarian', 'gluten_free'],
    prepTimeMin: 15,
    difficulty: 1,
