...
export const LUNCHES_EXTRA: Meal[] = [
  ...
  // TOTAL => cal 365, P 38.9, C 31.8, F 9.2
  {
    ...
    slot: 'lunch',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/29/Beef_bourguignon_NYT.jpg/800px-Beef_bourguignon_NYT.jpg',
    budget: 'eco',
  ...
  // TOTAL => cal 468, P 57.5, C 42.4, F 6.9
  {
    ...
    slot: 'lunch',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c3/Blanquette_de_veau_%C3%A0_l%27ancienne_04.jpg/800px-Blanquette_de_veau_%C3%A0_l%27ancienne_04.jpg',
    budget: 'eco',
  ...
  // TOTAL => cal 418, P 39.7, C 34.3, F 13
  {
    ...
    slot: 'lunch',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/52/Homerton_College_-_Shepherd%27s_pie_%28cropped%29.jpg/800px-Homerton_College_-_Shepherd%27s_pie_%28cropped%29.jpg',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'gluten_free'],
    prepTimeMin: 35,
    difficulty: 2,
  ...
  // TOTAL => cal 342, P 41.2, C 9.4, F 16.1
  {
    ...
    slot: 'lunch',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/88/Nizza-Salat_an_der_F_Mittelmeerk%C3%BCste.JPG/800px-Nizza-Salat_an_der_F_Mittelmeerk%C3%BCste.JPG',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'gluten_free', 'lactose_free'],
    prepTimeMin: 15,
    difficulty: 1,
  ...
  // TOTAL => cal 470, P 36.8, C 39.8, F 17.8
  {
    ...
    slot: 'lunch',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/ec/Shoyu_ramen%2C_at_Kasukabe_Station_%282014.05.05%29_1.jpg/800px-Shoyu_ramen%2C_at_Kasukabe_Station_%282014.05.05%29_1.jpg',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'gluten_free', 'lactose_free'],
    prepTimeMin: 25,
    difficulty: 2,
  ...
  // TOTAL => cal 330, P 29.8, C 25.9, F 11.8
  {
    ...
    slot: 'lunch',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/0c/B%C3%A1nh_m%C3%AC_th%E1%BB%8Bt_n%C6%B0%E1%BB%9Bng.png/800px-B%C3%A1nh_m%C3%AC_th%E1%BB%8Bt_n%C6%B0%E1%BB%9Bng.png',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'gluten_free', 'lactose_free'],
    prepTimeMin: 20,
    difficulty: 2,
  ...
  // TOTAL => cal 460, P 33.6, C 40.2, F 19.9
  {
    ...
    slot: 'lunch',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/97/Kakeudon.jpg/800px-Kakeudon.jpg',
    budget: 'eco',
  ...
  // TOTAL => cal 392, P 36.8, C 36.7, F 11.5
  {
    ...
    slot: 'lunch',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c7/Nasi_Goreng_Kampung_%2811967588375%29.jpg/800px-Nasi_Goreng_Kampung_%2811967588375%29.jpg',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'lactose_free'],
    prepTimeMin: 15,
    difficulty: 2,
  ...
  // TOTAL => cal 464, P 51.3, C 37.1, F 10.6
  {
    ...
    slot: 'lunch',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e3/%D0%A8%D0%B0%D1%83%D1%80%D0%BC%D0%B0_6.jpg/800px-%D0%A8%D0%B0%D1%83%D1%80%D0%BC%D0%B0_6.jpg',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'lactose_free'],
    prepTimeMin: 15,
    difficulty: 1,
  ...
  // TOTAL => cal 408, P 24.2, C 35.9, F 18.2
  {
    ...
    slot: 'lunch',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/93/Fattoush_mixed-salad.jpg/800px-Fattoush_mixed-salad.jpg',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'vegetarian'],
    prepTimeMin: 20,
    difficulty: 1,
  ...
  // TOTAL => cal 419, P 24.4, C 26.2, F 25.8
  {
    ...
    slot: 'lunch',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c7/Lahmacun.jpg/800px-Lahmacun.jpg',
    budget: 'premium',
    restrictions: ['halal', 'pork_free', 'vegetarian'],
    prepTimeMin: 15,
    difficulty: 1,
  ...
  // TOTAL => cal 328, P 27.6, C 38.7, F 6.4
  {
    ...
    slot: 'lunch',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/88/Kibbeh3.jpg/800px-Kibbeh3.jpg',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'lactose_free'],
    prepTimeMin: 20,
    difficulty: 2,
  ...
  // TOTAL => cal 330, P 32, C 20.5, F 14.3
  {
    ...
    slot: 'lunch',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/86/Mansaf%2C_the_traditional_dish_of_Jordan.jpg/800px-Mansaf%2C_the_traditional_dish_of_Jordan.jpg',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'lactose_free'],
    prepTimeMin: 25,
    difficulty: 2,
  ...
  // TOTAL => cal 502, P 32.8, C 37.3, F 24.6
  {
    ...
    slot: 'lunch',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/51/Thieboudienne.JPG/800px-Thieboudienne.JPG',
    budget: 'premium',
    restrictions: ['halal', 'pork_free', 'gluten_free'],
    prepTimeMin: 35,
    difficulty: 3,
  ...
  // TOTAL => cal 319, P 31.8, C 42.4, F 2.1
  {
    ...
    slot: 'lunch',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/45/Poulet_Yassa_Chicken_rice_with_onion_sauce.jpg/800px-Poulet_Yassa_Chicken_rice_with_onion_sauce.jpg',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'gluten_free', 'lactose_free'],
    prepTimeMin: 35,
    difficulty: 2,
  ...
  // TOTAL => cal 476, P 39.7, C 36.8, F 18.2
  {
    ...
    slot: 'lunch',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/31/Mafe.malien.jpg/800px-Mafe.malien.jpg',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'gluten_free', 'lactose_free'],
    prepTimeMin: 30,
    difficulty: 2,
  ...
  // TOTAL => cal 491, P 39.2, C 37.7, F 20.6
  {
    ...
    slot: 'lunch',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/4f/Vendeuses_de_bananes_plantain.jpg/800px-Vendeuses_de_bananes_plantain.jpg',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'gluten_free', 'lactose_free'],
    prepTimeMin: 30,
    difficulty: 2,
  ...
  // TOTAL => cal 382, P 26.2, C 52.8, F 10
  {
    ...
    slot: 'lunch',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/0a/Jollof_Rice_with_Stew.jpg/800px-Jollof_Rice_with_Stew.jpg',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'gluten_free', 'lactose_free'],
    prepTimeMin: 20,
    difficulty: 1,
  ...
  // TOTAL => cal 422, P 47.9, C 40.9, F 5.6
  {
    ...
    slot: 'lunch',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/91/Ndol%C3%A8_%C3%A0_la_viande%2C_morue_et_crevettes.jpg/800px-Ndol%C3%A8_%C3%A0_la_viande%2C_morue_et_crevettes.jpg',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'gluten_free', 'lactose_free'],
    prepTimeMin: 30,
    difficulty: 2,
  ...
  // TOTAL => cal 403, P 34.1, C 33.2, F 17.3
  {
    ...
    slot: 'lunch',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/44/Attieke.JPG/800px-Attieke.JPG',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'gluten_free', 'lactose_free'],
    prepTimeMin: 30,
    difficulty: 2,
  ...
  // TOTAL => cal 326, P 27.6, C 50, F 1.9
  {
    ...
    slot: 'lunch',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/1f/Wrapped_fufu.jpg/800px-Wrapped_fufu.jpg',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'gluten_free', 'lactose_free'],
    prepTimeMin: 15,
    difficulty: 1,
  ...
  // TOTAL => cal 374, P 32, C 33, F 13.5
  {
    ...
    slot: 'lunch',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/78/Cebiche_de_corvina.JPG/800px-Cebiche_de_corvina.JPG',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'gluten_free', 'lactose_free'],
    prepTimeMin: 15,
    difficulty: 1,
  ...
  // TOTAL => cal 225, P 35.3, C 9.4, F 6.5
  {
    ...
    slot: 'lunch',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/90/Feijoada_%C3%A0_transmontada.jpg/800px-Feijoada_%C3%A0_transmontada.jpg',
    budget: 'premium',
    restrictions: ['halal', 'pork_free', 'gluten_free', 'lactose_free'],
    prepTimeMin: 20,
    difficulty: 2,
  ...
  // TOTAL => cal 395, P 31.7, C 52.3, F 6.2
  {
    ...
    slot: 'lunch',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/ec/Enchilada_Rice_Beans.jpg/800px-Enchilada_Rice_Beans.jpg',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'gluten_free', 'lactose_free'],
    prepTimeMin: 30,
    difficulty: 2,
  ...
  // TOTAL => cal 438, P 51.6, C 31.8, F 10.8
  {
    ...
    slot: 'lunch',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/6e/Chimichurri_Sauce_Recipe_%2813294574784%29.jpg/800px-Chimichurri_Sauce_Recipe_%2813294574784%29.jpg',
    budget: 'eco',
    restrictions: ['halal', 'pork_free'],
    prepTimeMin: 25,
    difficulty: 2,
  ...
  // TOTAL => cal 393, P 41.3, C 21.7, F 15.7
  {
    ...
    slot: 'lunch',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/39/Arroz-con-Pollo.jpg/800px-Arroz-con-Pollo.jpg',
    budget: 'premium',
    restrictions: ['halal', 'pork_free', 'gluten_free', 'lactose_free'],
    prepTimeMin: 20,
    difficulty: 2,
  ...
  // TOTAL => cal 409, P 23.4, C 34.5, F 19.4
  {
    ...
    slot: 'lunch',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/3f/%28Pasta%29_by_David_Adam_Kess_%28pic.2%29.jpg/800px-%28Pasta%29_by_David_Adam_Kess_%28pic.2%29.jpg',
    budget: 'premium',
    restrictions: ['halal', 'pork_free', 'gluten_free', 'lactose_free'],
    prepTimeMin: 15,
    difficulty: 1,
