...
export const BEDTIME_SNACKS_EXTRA: Meal[] = [
  ...
  // Total: cal=292, p=24, c=16, f=15
  {
    ...
    slot: 'bedtime',
    photoUrl: 'https://images.pexels.com/photos/8743831/pexels-photo-8743831.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['vegetarian', 'gluten_free', 'halal', 'pork_free'],
    prepTimeMin: 2,
    difficulty: 1,
  ...
  // Total: cal=196, p=21, c=14, f=8
  {
    ...
    slot: 'bedtime',
    photoUrl: 'https://images.pexels.com/photos/34224587/pexels-photo-34224587.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['vegetarian', 'gluten_free', 'halal', 'pork_free'],
    prepTimeMin: 2,
    difficulty: 1,
  ...
  // Total: cal=151, p=16, c=23, f=0
  {
    ...
    slot: 'bedtime',
    photoUrl: 'https://images.pexels.com/photos/37907507/pexels-photo-37907507.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['vegetarian', 'gluten_free', 'halal', 'pork_free'],
    prepTimeMin: 2,
    difficulty: 1,
  ...
  // Total: cal=253, p=22, c=22, f=9
  {
    ...
    slot: 'bedtime',
    photoUrl: 'https://images.pexels.com/photos/7839801/pexels-photo-7839801.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['vegetarian', 'gluten_free', 'halal', 'pork_free'],
    prepTimeMin: 3,
    difficulty: 1,
  ...
  // Total: cal=214, p=22, c=17, f=7
  {
    ...
    slot: 'bedtime',
    photoUrl: 'https://images.pexels.com/photos/8635161/pexels-photo-8635161.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['vegetarian', 'gluten_free', 'halal', 'pork_free'],
    prepTimeMin: 2,
    difficulty: 1,
  ...
  // Total: cal=223, p=27, c=17, f=5
  {
    ...
    slot: 'bedtime',
    photoUrl: 'https://images.pexels.com/photos/13520599/pexels-photo-13520599.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['vegetarian', 'gluten_free', 'halal', 'pork_free'],
    prepTimeMin: 4,
    difficulty: 1,
  ...
  // Total: cal=245, p=26, c=29, f=3
  {
    ...
    slot: 'bedtime',
    photoUrl: 'https://images.pexels.com/photos/4397288/pexels-photo-4397288.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['vegetarian', 'halal', 'pork_free'],
    prepTimeMin: 5,
    difficulty: 1,
  ...
  // Total: cal=240, p=17, c=11, f=15
  {
    ...
    slot: 'bedtime',
    photoUrl: 'https://images.pexels.com/photos/5803163/pexels-photo-5803163.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'premium',
    restrictions: ['vegan', 'vegetarian', 'gluten_free', 'lactose_free', 'halal', 'pork_free'],
    prepTimeMin: 5,
    difficulty: 1,
