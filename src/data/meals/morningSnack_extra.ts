...
export const MORNING_SNACKS_EXTRA: Meal[] = [
  ...
  // => cal 221.2, P 5.7, C 34.5, F 6.7 => rounded: 221, 6, 35, 7
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/1f/2014_Bruschetta_The_Larder_Chiang_Mai.jpg/800px-2014_Bruschetta_The_Larder_Chiang_Mai.jpg',
    budget: 'eco',
    restrictions: ['vegan', 'vegetarian', 'lactose_free', 'halal', 'pork_free'],
    prepTimeMin: 5,
    difficulty: 1,
