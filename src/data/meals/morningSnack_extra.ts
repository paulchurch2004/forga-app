...
export const MORNING_SNACKS_EXTRA: Meal[] = [
  ...
  // => cal 301.75, P 32.825, C 31.65, F 5.475 => rounded: 302, 33, 32, 5
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/18142623/pexels-photo-18142623.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['vegetarian', 'halal', 'pork_free'],
    prepTimeMin: 2,
    difficulty: 1,
  ...
  // => cal 265.75, P 3.175, C 34.75, F 14.775 => rounded: 266, 3, 35, 15
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/775030/pexels-photo-775030.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'premium',
  ...
  // => cal 293.5, P 8.68, C 37.8, F 13.34 => rounded: 294, 9, 38, 13
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/5430819/pexels-photo-5430819.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['vegan', 'vegetarian', 'gluten_free', 'lactose_free', 'halal', 'pork_free'],
    prepTimeMin: 2,
    difficulty: 1,
  ...
  // => cal 324.9, P 6.55, C 51.1, F 11.15 => rounded: 325, 7, 51, 11
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/36285315/pexels-photo-36285315.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['vegan', 'vegetarian', 'lactose_free', 'halal', 'pork_free'],
    prepTimeMin: 2,
    difficulty: 1,
