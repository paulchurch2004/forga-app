...
export const MORNING_SNACKS_EXTRA: Meal[] = [
  ...
  // => cal 357, P 23.2, C 23, F 20.73 => rounded: 357, 23, 23, 21
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/31490093/pexels-photo-31490093.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
  ...
  // => cal 346, P 37.75, C 23.2, F 14.15 => rounded: 346, 38, 23, 14
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/23384624/pexels-photo-23384624.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['vegetarian', 'halal', 'pork_free'],
    prepTimeMin: 2,
    difficulty: 1,
  ...
  // => cal 230.5, P 23.55, C 27.4, F 3.95 => rounded: 231, 24, 27, 4
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/37283271/pexels-photo-37283271.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['vegetarian', 'halal', 'pork_free'],
    prepTimeMin: 3,
    difficulty: 1,
  ...
  // => cal 283.2, P 8.05, C 41.6, F 11.2 => rounded: 283, 8, 42, 11
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/12363203/pexels-photo-12363203.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
  ...
  // => cal 301.75, P 32.825, C 31.65, F 5.475 => rounded: 302, 33, 32, 5
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/1438080/pexels-photo-1438080.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['vegetarian', 'halal', 'pork_free'],
    prepTimeMin: 2,
    difficulty: 1,
  ...
  // => cal 217.4, P 27.53, C 25.4, F 1.85 => rounded: 217, 28, 25, 2
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/28117065/pexels-photo-28117065.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['vegetarian', 'halal', 'pork_free'],
    prepTimeMin: 3,
    difficulty: 1,
  ...
  // => cal 178.9, P 16.03, C 28.6, F 1 => rounded: 179, 16, 29, 1
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/14509267/pexels-photo-14509267.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
  ...
  // => cal 265.75, P 3.175, C 34.75, F 14.775 => rounded: 266, 3, 35, 15
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/8215110/pexels-photo-8215110.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'premium',
  ...
  // => cal 245.3, P 6.62, C 31.25, F 11.11 => rounded: 245, 7, 31, 11
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/7936964/pexels-photo-7936964.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['vegan', 'vegetarian', 'lactose_free', 'halal', 'pork_free'],
    prepTimeMin: 3,
    difficulty: 1,
  ...
  // => cal 221.2, P 5.7, C 34.5, F 6.7 => rounded: 221, 6, 35, 7
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/11789787/pexels-photo-11789787.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['vegan', 'vegetarian', 'lactose_free', 'halal', 'pork_free'],
    prepTimeMin: 5,
    difficulty: 1,
  ...
  // => cal 267.8, P 8.25, C 29.85, F 12.3 => rounded: 268, 8, 30, 12
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/12955763/pexels-photo-12955763.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'premium',
    restrictions: ['vegetarian', 'halal', 'pork_free'],
    prepTimeMin: 3,
    difficulty: 1,
  ...
  // => cal 293.5, P 8.68, C 37.8, F 13.34 => rounded: 294, 9, 38, 13
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/34227788/pexels-photo-34227788.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['vegan', 'vegetarian', 'gluten_free', 'lactose_free', 'halal', 'pork_free'],
    prepTimeMin: 2,
    difficulty: 1,
  ...
  // => cal 298.2, P 12.045, C 39.9, F 9.9 => rounded: 298, 12, 40, 10
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/5836438/pexels-photo-5836438.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['vegetarian', 'halal', 'pork_free'],
    prepTimeMin: 3,
    difficulty: 1,
  ...
  // => cal 225, P 6.7, C 26, F 12.8 => rounded: 225, 7, 26, 13
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/13887557/pexels-photo-13887557.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['vegan', 'vegetarian', 'gluten_free', 'lactose_free', 'halal', 'pork_free'],
    prepTimeMin: 2,
    difficulty: 1,
  ...
  // => cal 233.5, P 6.35, C 28.5, F 12.55 => rounded: 234, 6, 29, 13
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/7167858/pexels-photo-7167858.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['vegan', 'vegetarian', 'gluten_free', 'lactose_free', 'halal', 'pork_free'],
    prepTimeMin: 1,
    difficulty: 1,
  ...
  // => cal 147.4, P 12.83, C 23.9, F 0.45 => rounded: 147, 13, 24, 0
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/15048298/pexels-photo-15048298.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['vegetarian', 'gluten_free', 'halal', 'pork_free'],
    prepTimeMin: 2,
    difficulty: 1,
  ...
  // => cal 281.8, P 5.28, C 49.4, F 9.92 => rounded: 282, 5, 49, 10
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/32692730/pexels-photo-32692730.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['vegan', 'vegetarian', 'gluten_free', 'lactose_free', 'halal', 'pork_free'],
    prepTimeMin: 3,
    difficulty: 1,
  ...
  // => cal 147, P 11.85, C 21.6, F 2.4 => rounded: 147, 12, 22, 2
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/9670689/pexels-photo-9670689.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
  ...
  // => cal 201.3, P 4.5, C 20.8, F 13.15 => rounded: 201, 5, 21, 13
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/14996603/pexels-photo-14996603.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['vegan', 'vegetarian', 'gluten_free', 'lactose_free', 'halal', 'pork_free'],
    prepTimeMin: 2,
    difficulty: 1,
  ...
  // => cal 341, P 7.65, C 65.8, F 9.65 => rounded: 341, 8, 66, 10
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/27850069/pexels-photo-27850069.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['vegan', 'vegetarian', 'lactose_free', 'halal', 'pork_free'],
    prepTimeMin: 10,
    difficulty: 2,
  ...
  // => cal 299.1, P 8.61, C 46.5, F 9.95 => rounded: 299, 9, 47, 10
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/31024449/pexels-photo-31024449.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
  ...
  // => cal 291.1, P 10.33, C 33.3, F 14.45 => rounded: 291, 10, 33, 14
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/10003794/pexels-photo-10003794.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['vegetarian', 'lactose_free', 'halal', 'pork_free'],
    prepTimeMin: 10,
    difficulty: 2,
  ...
  // => cal 292.75, P 4.47, C 38.1, F 15.98 => rounded: 293, 4, 38, 16
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/3026811/pexels-photo-3026811.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['vegan', 'vegetarian', 'gluten_free', 'lactose_free', 'halal', 'pork_free'],
    prepTimeMin: 10,
    difficulty: 2,
  ...
  // => cal 277.8, P 14.03, C 37.4, F 8.4 => rounded: 278, 14, 37, 8
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/4006347/pexels-photo-4006347.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['vegetarian', 'halal', 'pork_free'],
    prepTimeMin: 2,
    difficulty: 1,
  ...
  // => cal 323.3, P 4.7, C 43.7, F 17.2 => rounded: 323, 5, 44, 17
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/19063542/pexels-photo-19063542.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['vegan', 'vegetarian', 'gluten_free', 'lactose_free', 'halal', 'pork_free'],
    prepTimeMin: 5,
    difficulty: 1,
  ...
  // => cal 162.4, P 4.61, C 7.93, F 12.68 => rounded: 162, 5, 8, 13
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/5191834/pexels-photo-5191834.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'premium',
    restrictions: ['vegetarian', 'gluten_free', 'halal', 'pork_free'],
    prepTimeMin: 3,
    difficulty: 1,
  ...
  // => cal 146.4, P 13.2, C 12, F 6 => rounded: 146, 13, 12, 6
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/29935499/pexels-photo-29935499.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['vegan', 'vegetarian', 'gluten_free', 'lactose_free', 'halal', 'pork_free'],
    prepTimeMin: 5,
    difficulty: 1,
  ...
  // => cal 141.4, P 6.02, C 18.56, F 6.22 => rounded: 141, 6, 19, 6
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/34644302/pexels-photo-34644302.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['vegan', 'vegetarian', 'gluten_free', 'lactose_free', 'halal', 'pork_free'],
    prepTimeMin: 5,
    difficulty: 1,
  ...
  // => cal 209.6, P 8.4, C 30.8, F 6.4 => rounded: 210, 8, 31, 6
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/12431190/pexels-photo-12431190.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['vegan', 'vegetarian', 'lactose_free', 'halal', 'pork_free'],
    prepTimeMin: 5,
    difficulty: 1,
  ...
  // => cal 282.5, P 6.45, C 30.1, F 16.2 => rounded: 283, 6, 30, 16
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/4397296/pexels-photo-4397296.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['vegan', 'vegetarian', 'gluten_free', 'lactose_free', 'halal', 'pork_free'],
    prepTimeMin: 5,
    difficulty: 1,
  ...
  // => cal 202.2, P 19.26, C 26.04, F 3.26 => rounded: 202, 19, 26, 3
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/1194369/pexels-photo-1194369.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'premium',
    restrictions: ['vegan', 'vegetarian', 'gluten_free', 'lactose_free', 'halal', 'pork_free'],
    prepTimeMin: 3,
    difficulty: 1,
  ...
  // => cal 205.3, P 9.7, C 32.9, F 4.3 => rounded: 205, 10, 33, 4
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/37978583/pexels-photo-37978583.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['vegan', 'vegetarian', 'gluten_free', 'lactose_free', 'halal', 'pork_free'],
    prepTimeMin: 5,
    difficulty: 1,
  ...
  // => cal 324.9, P 6.55, C 51.1, F 11.15 => rounded: 325, 7, 51, 11
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/14407470/pexels-photo-14407470.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['vegan', 'vegetarian', 'lactose_free', 'halal', 'pork_free'],
    prepTimeMin: 2,
    difficulty: 1,
  ...
  // => cal 138.14, P 20.095, C 12.92, F 0.82 => rounded: 138, 20, 13, 1
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/11182249/pexels-photo-11182249.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['vegetarian', 'gluten_free', 'halal', 'pork_free'],
    prepTimeMin: 1,
    difficulty: 1,
  ...
  // => cal 118.6, P 4.96, C 18.08, F 4.38 => rounded: 119, 5, 18, 4
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/34227783/pexels-photo-34227783.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['vegan', 'vegetarian', 'gluten_free', 'lactose_free', 'halal', 'pork_free'],
    prepTimeMin: 5,
    difficulty: 1,
  ...
  // => cal 162, P 17.2, C 8.7, F 6.55 => rounded: 162, 17, 9, 7
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/20929210/pexels-photo-20929210.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['vegetarian', 'gluten_free', 'halal', 'pork_free'],
    prepTimeMin: 3,
    difficulty: 1,
  ...
  // => cal 162, P 22.64, C 16, F 0.64 => rounded: 162, 23, 16, 1
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/5945660/pexels-photo-5945660.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['vegetarian', 'gluten_free', 'halal', 'pork_free'],
    prepTimeMin: 2,
    difficulty: 1,
