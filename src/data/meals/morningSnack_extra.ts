...
export const MORNING_SNACKS_EXTRA: Meal[] = [
  ...
  // => cal 346, P 37.75, C 23.2, F 14.15 => rounded: 346, 38, 23, 14
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/5846193/pexels-photo-5846193.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['vegetarian', 'halal', 'pork_free'],
    prepTimeMin: 2,
    difficulty: 1,
  ...
  // => cal 283.2, P 8.05, C 41.6, F 11.2 => rounded: 283, 8, 42, 11
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/1750963/pexels-photo-1750963.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
  ...
  // => cal 301.75, P 32.825, C 31.65, F 5.475 => rounded: 302, 33, 32, 5
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/4378601/pexels-photo-4378601.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['vegetarian', 'halal', 'pork_free'],
    prepTimeMin: 2,
    difficulty: 1,
  ...
  // => cal 265.75, P 3.175, C 34.75, F 14.775 => rounded: 266, 3, 35, 15
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/775031/pexels-photo-775031.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'premium',
  ...
  // => cal 221.2, P 5.7, C 34.5, F 6.7 => rounded: 221, 6, 35, 7
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/2090922/pexels-photo-2090922.png?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['vegan', 'vegetarian', 'lactose_free', 'halal', 'pork_free'],
    prepTimeMin: 5,
    difficulty: 1,
  ...
  // => cal 332.55, P 11.225, C 47.05, F 12.325 => rounded: 333, 11, 47, 12
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/7936733/pexels-photo-7936733.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['vegan', 'vegetarian', 'lactose_free', 'halal', 'pork_free'],
    prepTimeMin: 3,
    difficulty: 1,
  ...
  // => cal 293.5, P 8.68, C 37.8, F 13.34 => rounded: 294, 9, 38, 13
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/13392726/pexels-photo-13392726.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['vegan', 'vegetarian', 'gluten_free', 'lactose_free', 'halal', 'pork_free'],
    prepTimeMin: 2,
    difficulty: 1,
  ...
  // => cal 225, P 6.7, C 26, F 12.8 => rounded: 225, 7, 26, 13
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/11405133/pexels-photo-11405133.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['vegan', 'vegetarian', 'gluten_free', 'lactose_free', 'halal', 'pork_free'],
    prepTimeMin: 2,
    difficulty: 1,
  ...
  // => cal 233.5, P 6.35, C 28.5, F 12.55 => rounded: 234, 6, 29, 13
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/7167845/pexels-photo-7167845.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['vegan', 'vegetarian', 'gluten_free', 'lactose_free', 'halal', 'pork_free'],
    prepTimeMin: 1,
    difficulty: 1,
  ...
  // => cal 281.8, P 5.28, C 49.4, F 9.92 => rounded: 282, 5, 49, 10
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/8712908/pexels-photo-8712908.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['vegan', 'vegetarian', 'gluten_free', 'lactose_free', 'halal', 'pork_free'],
    prepTimeMin: 3,
    difficulty: 1,
  ...
  // => cal 291.1, P 10.33, C 33.3, F 14.45 => rounded: 291, 10, 33, 14
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/9646388/pexels-photo-9646388.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['vegetarian', 'lactose_free', 'halal', 'pork_free'],
    prepTimeMin: 10,
    difficulty: 2,
  ...
  // => cal 277.8, P 14.03, C 37.4, F 8.4 => rounded: 278, 14, 37, 8
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/566564/pexels-photo-566564.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['vegetarian', 'halal', 'pork_free'],
    prepTimeMin: 2,
    difficulty: 1,
  ...
  // => cal 205.75, P 14.01, C 33.95, F 0.771 => rounded: 206, 14, 34, 1
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/28559538/pexels-photo-28559538.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
  ...
  // => cal 210.2, P 5.05, C 35, F 7.9 => rounded: 210, 5, 35, 8
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/12362298/pexels-photo-12362298.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['vegan', 'vegetarian', 'gluten_free', 'lactose_free', 'halal', 'pork_free'],
    prepTimeMin: 10,
    difficulty: 2,
  ...
  // => cal 162.4, P 4.61, C 7.93, F 12.68 => rounded: 162, 5, 8, 13
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/37417609/pexels-photo-37417609.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'premium',
    restrictions: ['vegetarian', 'gluten_free', 'halal', 'pork_free'],
    prepTimeMin: 3,
    difficulty: 1,
  ...
  // => cal 324.9, P 6.55, C 51.1, F 11.15 => rounded: 325, 7, 51, 11
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/28278525/pexels-photo-28278525.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['vegan', 'vegetarian', 'lactose_free', 'halal', 'pork_free'],
    prepTimeMin: 2,
    difficulty: 1,
  ...
  // => cal 118.6, P 4.96, C 18.08, F 4.38 => rounded: 119, 5, 18, 4
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/34636899/pexels-photo-34636899.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['vegan', 'vegetarian', 'gluten_free', 'lactose_free', 'halal', 'pork_free'],
    prepTimeMin: 5,
    difficulty: 1,
  ...
  // => cal 162, P 22.64, C 16, F 0.64 => rounded: 162, 23, 16, 1
  {
    ...
    slot: 'morning_snack',
    photoUrl: 'https://images.pexels.com/photos/5945598/pexels-photo-5945598.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['vegetarian', 'gluten_free', 'halal', 'pork_free'],
    prepTimeMin: 2,
    difficulty: 1,
