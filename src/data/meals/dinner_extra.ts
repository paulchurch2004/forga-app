...
export const DINNERS_EXTRA: Meal[] = [
  ...
  // TOTAL => cal 699, P 33.2, C 45.2, F 42.5
  {
    ...
    slot: 'dinner',
    photoUrl: 'https://images.pexels.com/photos/7786802/pexels-photo-7786802.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'premium',
    restrictions: ['halal', 'pork_free', 'gluten_free', 'lactose_free'],
    prepTimeMin: 30,
    difficulty: 3,
  ...
  // TOTAL => cal 363, P 41.9, C 10.7, F 18.6
  {
    ...
    slot: 'dinner',
    photoUrl: 'https://images.pexels.com/photos/6046491/pexels-photo-6046491.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'premium',
    restrictions: ['halal', 'pork_free', 'gluten_free', 'lactose_free'],
    prepTimeMin: 15,
    difficulty: 1,
  ...
  // TOTAL => cal 361, P 35, C 34.5, F 8.8
  {
    ...
    slot: 'dinner',
    photoUrl: 'https://images.pexels.com/photos/6646068/pexels-photo-6646068.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'gluten_free', 'lactose_free'],
    prepTimeMin: 25,
    difficulty: 2,
  ...
  // TOTAL => cal 600, P 38.2, C 45.2, F 28.1
  {
    ...
    slot: 'dinner',
    photoUrl: 'https://images.pexels.com/photos/11129150/pexels-photo-11129150.png?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'premium',
    restrictions: ['halal', 'pork_free', 'gluten_free', 'lactose_free'],
    prepTimeMin: 25,
    difficulty: 2,
  ...
  // TOTAL => cal 508, P 45, C 48, F 14.3
  {
    ...
    slot: 'dinner',
    photoUrl: 'https://images.pexels.com/photos/13065185/pexels-photo-13065185.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'lactose_free'],
    prepTimeMin: 20,
    difficulty: 1,
  ...
  // TOTAL => cal 492, P 57.5, C 37.1, F 11.4
  {
    ...
    slot: 'dinner',
    photoUrl: 'https://images.pexels.com/photos/10756648/pexels-photo-10756648.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'gluten_free', 'lactose_free'],
    prepTimeMin: 15,
    difficulty: 1,
  ...
  // TOTAL => cal 410, P 47, C 31.2, F 11.7
  {
    ...
    slot: 'dinner',
    photoUrl: 'https://images.pexels.com/photos/7439809/pexels-photo-7439809.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'lactose_free'],
    prepTimeMin: 25,
    difficulty: 2,
  ...
  // TOTAL => cal 543, P 61.3, C 54.3, F 8
  {
    ...
    slot: 'dinner',
    photoUrl: 'https://images.pexels.com/photos/8995196/pexels-photo-8995196.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'lactose_free'],
    prepTimeMin: 30,
    difficulty: 2,
  ...
  // TOTAL => cal 439, P 42.4, C 32.4, F 15.4
  {
    ...
    slot: 'dinner',
    photoUrl: 'https://images.pexels.com/photos/19748955/pexels-photo-19748955.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'gluten_free', 'lactose_free'],
    prepTimeMin: 30,
    difficulty: 2,
  ...
  // TOTAL => cal 483, P 42, C 41.2, F 16.7
  {
    ...
    slot: 'dinner',
    photoUrl: 'https://images.pexels.com/photos/19863261/pexels-photo-19863261.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'premium',
    restrictions: ['halal', 'pork_free', 'lactose_free'],
    prepTimeMin: 40,
    difficulty: 2,
  ...
  // TOTAL => cal 453, P 39.3, C 50.7, F 12.8
  {
    ...
    slot: 'dinner',
    photoUrl: 'https://images.pexels.com/photos/37297762/pexels-photo-37297762.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'gluten_free', 'lactose_free'],
    prepTimeMin: 30,
    difficulty: 2,
  ...
  // TOTAL => cal 395, P 42.2, C 53.5, F 1.4
  {
    ...
    slot: 'dinner',
    photoUrl: 'https://images.pexels.com/photos/13994299/pexels-photo-13994299.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'gluten_free', 'lactose_free'],
    prepTimeMin: 30,
    difficulty: 2,
  ...
  // TOTAL => cal 540, P 60.6, C 38.1, F 14.9
  {
    ...
    slot: 'dinner',
    photoUrl: 'https://images.pexels.com/photos/36925851/pexels-photo-36925851.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['halal', 'pork_free'],
    prepTimeMin: 15,
    difficulty: 1,
  ...
  // TOTAL => cal 524, P 49.4, C 45.5, F 16.7
  {
    ...
    slot: 'dinner',
    photoUrl: 'https://images.pexels.com/photos/28490807/pexels-photo-28490807.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'gluten_free', 'lactose_free'],
    prepTimeMin: 35,
    difficulty: 2,
  ...
  // TOTAL => cal 440, P 39.1, C 39.5, F 15.1
  {
    ...
    slot: 'dinner',
    photoUrl: 'https://images.pexels.com/photos/34429593/pexels-photo-34429593.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'gluten_free', 'lactose_free'],
    prepTimeMin: 20,
    difficulty: 1,
  ...
  // TOTAL => cal 346, P 10.8, C 41.3, F 16.9
  {
    ...
    slot: 'dinner',
    photoUrl: 'https://images.pexels.com/photos/4187620/pexels-photo-4187620.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'vegan', 'vegetarian', 'gluten_free', 'lactose_free'],
    prepTimeMin: 25,
    difficulty: 1,
  ...
  // TOTAL => cal 397, P 34.6, C 39.6, F 13.6
  {
    ...
    slot: 'dinner',
    photoUrl: 'https://images.pexels.com/photos/36371693/pexels-photo-36371693.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'vegan', 'vegetarian', 'lactose_free'],
    prepTimeMin: 20,
    difficulty: 2,
  ...
  // TOTAL => cal 494, P 45.1, C 60.8, F 9.4
  {
    ...
    slot: 'dinner',
    photoUrl: 'https://images.pexels.com/photos/6805051/pexels-photo-6805051.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'vegan', 'vegetarian', 'lactose_free'],
    prepTimeMin: 20,
    difficulty: 1,
  ...
  // TOTAL => cal 435, P 32.8, C 36.5, F 19.6
  {
    ...
    slot: 'dinner',
    photoUrl: 'https://images.pexels.com/photos/4518581/pexels-photo-4518581.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'vegan', 'vegetarian', 'gluten_free', 'lactose_free'],
    prepTimeMin: 20,
    difficulty: 2,
  ...
  // TOTAL => cal 354, P 20.4, C 67.5, F 2.1
  {
    ...
    slot: 'dinner',
    photoUrl: 'https://images.pexels.com/photos/27626470/pexels-photo-27626470.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'vegan', 'vegetarian', 'gluten_free', 'lactose_free'],
    prepTimeMin: 25,
    difficulty: 1,
  ...
  // TOTAL => cal 407, P 29.6, C 13, F 26.6
  {
    ...
    slot: 'dinner',
    photoUrl: 'https://images.pexels.com/photos/14302155/pexels-photo-14302155.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'vegetarian', 'gluten_free'],
    prepTimeMin: 20,
    difficulty: 1,
  ...
  // TOTAL => cal 495, P 27.1, C 29, F 31.2
  {
    ...
    slot: 'dinner',
    photoUrl: 'https://images.pexels.com/photos/13422458/pexels-photo-13422458.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'eco',
  ...
  // TOTAL => cal 511, P 35.2, C 43.1, F 20
  {
    ...
    slot: 'dinner',
    photoUrl: 'https://images.pexels.com/photos/20570600/pexels-photo-20570600.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
    budget: 'premium',
    restrictions: ['halal', 'pork_free', 'lactose_free'],
    prepTimeMin: 20,
    difficulty: 2,
