...
export const DINNERS_EXTRA: Meal[] = [
  ...
  // TOTAL => cal 521, P 48.8, C 56.1, F 11.6
  {
    ...
    slot: 'dinner',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f0/Pot-au-feu_SAM_2724.JPG/800px-Pot-au-feu_SAM_2724.JPG',
    budget: 'eco',
  ...
  // TOTAL => cal 421, P 59.6, C 17.6, F 12.4
  {
    ...
    slot: 'dinner',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/00/Cichorium_endivia_-_Botanischer_Garten_Mainz_IMG_5453.JPG/800px-Cichorium_endivia_-_Botanischer_Garten_Mainz_IMG_5453.JPG',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'gluten_free', 'lactose_free'],
    prepTimeMin: 30,
    difficulty: 2,
  ...
  // TOTAL => cal 442, P 64.8, C 3, F 18.9
  {
    ...
    slot: 'dinner',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d7/Brandada_de_Bacalao_-_098.jpg/800px-Brandada_de_Bacalao_-_098.jpg',
    budget: 'eco',
  ...
  // TOTAL => cal 472, P 39.1, C 4.7, F 31.9
  {
    ...
    slot: 'dinner',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/70/Sealife%2C_Bray%2C_Ireland._%286985874908%29.jpg/800px-Sealife%2C_Bray%2C_Ireland._%286985874908%29.jpg',
    budget: 'premium',
    restrictions: ['halal', 'pork_free', 'gluten_free'],
    prepTimeMin: 20,
    difficulty: 2,
  ...
  // TOTAL => cal 290, P 39.3, C 7.5, F 12.3
  {
    ...
    slot: 'dinner',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/11/Holstein_cow_with_one-day_calf_01.jpg/800px-Holstein_cow_with_one-day_calf_01.jpg',
    budget: 'premium',
    restrictions: ['halal', 'pork_free', 'gluten_free', 'lactose_free'],
    prepTimeMin: 20,
    difficulty: 2,
  ...
  // TOTAL => cal 384, P 44.2, C 40.4, F 6.1
  {
    ...
    slot: 'dinner',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/03/Japanese_SilkyTofu_%28Kinugoshi_Tofu%29.JPG/800px-Japanese_SilkyTofu_%28Kinugoshi_Tofu%29.JPG',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'lactose_free'],
    prepTimeMin: 15,
    difficulty: 1,
  ...
  // TOTAL => cal 368, P 33.1, C 33.8, F 13.4
  {
    ...
    slot: 'dinner',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/04/Gyudon_by_jetalone_in_Higashi-Ginza%2C_Tokyo.jpg/800px-Gyudon_by_jetalone_in_Higashi-Ginza%2C_Tokyo.jpg',
    budget: 'eco',
  ...
  // TOTAL => cal 508, P 45, C 48, F 14.3
  {
    ...
    slot: 'dinner',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/1c/Nyonya_Laksa.jpg/800px-Nyonya_Laksa.jpg',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'lactose_free'],
    prepTimeMin: 20,
    difficulty: 1,
  ...
  // TOTAL => cal 444, P 40.1, C 32.7, F 17.3
  {
    ...
    slot: 'dinner',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/fe/Minestrone_soup_%285%29.jpg/800px-Minestrone_soup_%285%29.jpg',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'gluten_free', 'lactose_free'],
    prepTimeMin: 20,
    difficulty: 2,
  ...
  // TOTAL => cal 516, P 45.6, C 47.8, F 14.8
  {
    ...
    slot: 'dinner',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e5/Flickr_preppybyday_4711943668--Tom_kha_gai.jpg/800px-Flickr_preppybyday_4711943668--Tom_kha_gai.jpg',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'lactose_free'],
    prepTimeMin: 20,
    difficulty: 1,
  ...
  // TOTAL => cal 474, P 50.8, C 9.3, F 25.8
  {
    ...
    slot: 'dinner',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/a/ad/D%C3%B6ner_kebab_slicing.jpg',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'gluten_free', 'lactose_free'],
    prepTimeMin: 20,
    difficulty: 2,
  ...
  // TOTAL => cal 497, P 33.2, C 51.5, F 18.8
  {
    ...
    slot: 'dinner',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a8/MussakasMeMelitsanesKePatates01.JPG/800px-MussakasMeMelitsanesKePatates01.JPG',
    budget: 'premium',
    restrictions: ['halal', 'pork_free', 'gluten_free', 'lactose_free'],
    prepTimeMin: 40,
    difficulty: 2,
  ...
  // TOTAL => cal 439, P 42.4, C 32.4, F 15.4
  {
    ...
    slot: 'dinner',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8c/Lamb_meat_%281%29.jpg/800px-Lamb_meat_%281%29.jpg',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'gluten_free', 'lactose_free'],
    prepTimeMin: 30,
    difficulty: 2,
  ...
  // TOTAL => cal 483, P 42, C 41.2, F 16.7
  {
    ...
    slot: 'dinner',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/23/Chermoula_tagine.jpg/800px-Chermoula_tagine.jpg',
    budget: 'premium',
    restrictions: ['halal', 'pork_free', 'lactose_free'],
    prepTimeMin: 40,
    difficulty: 2,
  ...
  // TOTAL => cal 385, P 39.8, C 29.5, F 12.4
  {
    ...
    slot: 'dinner',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2d/Makluba.JPG/800px-Makluba.JPG',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'gluten_free', 'lactose_free'],
    prepTimeMin: 25,
    difficulty: 2,
  ...
  // TOTAL => cal 472, P 41.2, C 47.9, F 12.7
  {
    ...
    slot: 'dinner',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/4d/Kedjenou_-_01.jpg/800px-Kedjenou_-_01.jpg',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'gluten_free', 'lactose_free'],
    prepTimeMin: 25,
    difficulty: 2,
  ...
  // TOTAL => cal 401, P 46.3, C 18.9, F 16
  {
    ...
    slot: 'dinner',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/19/Fish_stuffed_with_Thai_herbs.jpg/800px-Fish_stuffed_with_Thai_herbs.jpg',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'gluten_free', 'lactose_free'],
    prepTimeMin: 35,
    difficulty: 2,
  ...
  // TOTAL => cal 485, P 42, C 63, F 7.1
  {
    ...
    slot: 'dinner',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/54/Ethiopian_wat.jpg/800px-Ethiopian_wat.jpg',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'gluten_free', 'lactose_free'],
    prepTimeMin: 15,
    difficulty: 1,
  ...
  // TOTAL => cal 508, P 47.4, C 53.8, F 10.9
  {
    ...
    slot: 'dinner',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/48/Chicken_Quesadilla_dish_at_Latin_Bistro_restaurant_Summit_NJ.JPG/800px-Chicken_Quesadilla_dish_at_Latin_Bistro_restaurant_Summit_NJ.JPG',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'gluten_free', 'lactose_free'],
    prepTimeMin: 20,
    difficulty: 1,
  ...
  // TOTAL => cal 540, P 60.6, C 38.1, F 14.9
  {
    ...
    slot: 'dinner',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/6b/Moqueca.jpg/800px-Moqueca.jpg',
    budget: 'eco',
    restrictions: ['halal', 'pork_free'],
    prepTimeMin: 15,
    difficulty: 1,
  ...
  // TOTAL => cal 466, P 37.7, C 38.1, F 18.5
  {
    ...
    slot: 'dinner',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9e/Picanha3.jpg/800px-Picanha3.jpg',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'gluten_free', 'lactose_free'],
    prepTimeMin: 25,
    difficulty: 2,
  ...
  // TOTAL => cal 454, P 50, C 31.8, F 14.4
  {
    ...
    slot: 'dinner',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/1e/Un_cuarto_de_Pollo_a_la_Brasa.JPG/800px-Un_cuarto_de_Pollo_a_la_Brasa.JPG',
    budget: 'premium',
    restrictions: ['halal', 'pork_free', 'gluten_free', 'lactose_free'],
    prepTimeMin: 20,
    difficulty: 2,
  ...
  // TOTAL => cal 524, P 49.4, C 45.5, F 16.7
  {
    ...
    slot: 'dinner',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/78/Tapa_de_empanadillitas.JPG/800px-Tapa_de_empanadillitas.JPG',
    budget: 'eco',
    restrictions: ['halal', 'pork_free', 'gluten_free', 'lactose_free'],
    prepTimeMin: 35,
    difficulty: 2,
  ...
  // TOTAL => cal 340, P 25.7, C 16.9, F 19.6
  {
    ...
    slot: 'dinner',
    photoUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/77/Frittata02.jpg/800px-Frittata02.jpg',
    budget: 'eco',
